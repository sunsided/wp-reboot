  <ul class="posts <?php if (is_search()) echo "searchfailed"; else echo "fourohfour"; ?>">
                ...
                <img id="fourohfour" src="{bloginfo 'stylesheet_directory'}/images/einstein404.png" alt="{translate 'Blog durchsucht - Nichts gefunden.'}" />

          <?php if (is_search()): ?>
                <h2 class="main">{translate 'Blog durchsucht - Nichts gefunden.'}</h2>
		<p>Du hast diesen Blog nach dem Inhalt <q><?php the_search_query(); ?></q> durchsucht. Wir haben wirklich überall nachgesehen, aber nichts passendes finden können.</p>
          <?php else: ?>
                <h2 class="main">{translate 'Unbekannt verzogen - Nichts gefunden.'}</h2>
